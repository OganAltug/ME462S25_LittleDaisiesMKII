Locking Mechanism:
- Mechanical:
  - The mechnism must be able to switch tools in less than 30 seconds.    
  - The mechanism must connect two sides without permanent fastening.
  - The mechanism must withstand axial load of 5kgs.
  - The mechanism must withstand torsional load of 6Nm.
  - The mechanism must withstand monment of 3Nm.
  - The mechanism must not shift more than 1 mm and 6 degrees in repetative usage.
  - The mechanism must allow manual disengage in less than 5 seconds in case of emergency.
  - The mechanism must be suitable to manufacture with basic robotics lab tools.
...
- Mechanical:
  ...
  - The Toolbox must allow user to disengage tools less than 60 secs in manual operation.
...
- Electrical:
  ...
  - The Toolbox must communicate with the arm to inicate the charge status of the active grippers.
  - The Toolbox PCB must be maximum of two layers.
...
- PCB:
  ...
  - The Handler PCB must be maximum of two layers.
  - The Handler PCB must be smaller than 8x8 cm in size.
  - The handler PCB components must be found in web less than 3 consecutive searches.
