...
- Naci designed and printed a design for the Gripper Mechanism. (Also, includes Raspery Pi 4) (/10)
  <img src="./girpper1.png" alt="gripping_mechanism" width="160"/>
- Ogan printed some versions of the Zen Tool with the interface of handler/locking mechanism tool side. (/10)
  <img src="./zen.jpg" alt="zen_mechanism" width="160"/>
- Deniz handled the tool box problems and printed. (/10)
- Fixed tool box is tested (/10)
  <video controls src="tool_box_video1.mp4" title="Title"></video>
  <img src="./tool_box.jpg" alt="tool_box_mechanism" width="160"/>
- Ogan tested different configration of the tool box. (/10)
  <video controls src="tool_box_video2.mp4" title="Title"></video>
- Buğra derived the kinematic relations for the Gripper Mechansim. (/10)
  - Derivations and the source code is added as well.
    <img src="./derivations.png" alt="kinematic_relations" width="160"/>

Point of this week (/10) = 


27.04.2026 Meeting Minute:
<img src="./meeting.jpg" alt="meeting" width="160"/>
...
- Options for the second active tool is discussed.
  - Some options:
    - A shooting mechanism for a nerflike mechanism
      <img src="./shooting_mechanism.jpg" alt="shooting_mechanism" width="160"/>
...
- Some decisions regarding to the process is decided.
  - Naci will finalize the gripper.
  - Naci will make progress about the electrical interface and pico.
  - Deniz & Buğra will deal with the image proccessing.
  - Ogan will try to move the arm with own robot control codes. (Movement of curve & arm solutions)
  - A final position of the tool box will be decided and will not be changed if anything important happens.
    - Regarding the final posiiton of the tool box, it will be positioned in the simulaitons and boundaries will be set.   
   
What have we done for TORNA this week????
<img src="./tornaci1.png" alt="tornaci" width="160"/>
<img src="./naci1.jpg" alt="tornaci" width="160"/>
<img src="./naci2.jpg" alt="tornaci" width="160"/>


What we are aiming to do this week:
- Naci will finalize the gripper.
- Naci will make progress about the electrical interface and pico.
- Deniz & Buğra will deal with the image proccessing. (Raspery pi 4 will be used. )
- Ogan will try to move the arm with own robot control codes. (Movement of curve & arm solutions)
- A final position of the tool box will be decided and will not be changed if anything important happens.
  - Regarding the final posiiton of the tool box, it will be positioned in the simulaitons and boundaries will be set. 
- Hopefully, with the use of image processing robot arm will be controlled.
